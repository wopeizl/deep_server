...
list(APPEND Deep_INCLUDE_DIRS PUBLIC ${PROTOBUF_INCLUDE_DIR})
list(APPEND Deep_LINKER_LIBS PUBLIC ${PROTOBUF_LIBRARIES})
...
if(PROTOBUF_FOUND)
  ...
  deep_parse_header(${PROTOBUF_INCLUDE_DIR}/google/protobuf/stubs/common.h VERION_LINE GOOGLE_PROTOBUF_VERSION)
...
set(proto_gen_folder "${PROJECT_BINARY_DIR}/include/deep/proto")
...
# Usage:
#   deep_protobuf_generate_cpp_py(<output_dir> <srcs_var> <hdrs_var> <python_var> <proto_files>)
function(deep_protobuf_generate_cpp_py output_dir srcs_var hdrs_var python_var)
  if(NOT ARGN)
    message(SEND_ERROR "Error: deep_protobuf_generate_cpp_py() called without any proto files")
    return()
  endif()
